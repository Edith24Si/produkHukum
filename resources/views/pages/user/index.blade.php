                    ...
                    <div class="row align-items-center">
                        <div class="col-md-2">
                            <select name="judul" class="form-select" onchange="this.form.submit()">
                                ...
                                <option value="username" {{ request('judul') == 'username' ? 'selected' : '' }}>Username</option>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        @else
                                            ...
                                            <div style="width: 50px; height: 50px; background-color: #007bff; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: 18px;">
