        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <div class="table-responsive">
                        <form method="GET" action="{{ route('produkHukum.index') }}" <div class="row">
                            <div class="col-md-2">
                                <select name="" class="form-select" onchange="this.form.submit()" class="mb-3">
                                    <option value="">All</option>
                                    <option value="Nomor" {{ request('judul') == 'Nomor' ? 'selected' : '' }}>Nomor</option>
